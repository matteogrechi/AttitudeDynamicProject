...
#include "UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_qvndnnH6.h"

void UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_qvndnnH6(
  ...
  real_T Pxy[49], real_T Sy[49])
{
  ...
  tmp[8] = (1.0 - varargin_1[4] * varargin_1[4] * 2.0) - varargin_1[5] *
    varargin_1[5] * 2.0;
  tmp_i[0] = (1.0 - varargin_1[12] * varargin_1[12] * 2.0) - varargin_1[13] *
    varargin_1[13] * 2.0;
  tmp_i[3] = 2.0 * varargin_1[11] * varargin_1[12] + 2.0 * varargin_1[10] *
    varargin_1[13];
  tmp_i[6] = -2.0 * varargin_1[10] * varargin_1[12] + 2.0 * varargin_1[11] *
    varargin_1[13];
  tmp_i[1] = 2.0 * varargin_1[11] * varargin_1[12] - 2.0 * varargin_1[10] *
    varargin_1[13];
  tmp_i[4] = (1.0 - varargin_1[11] * varargin_1[11] * 2.0) - varargin_1[13] *
    varargin_1[13] * 2.0;
  tmp_i[7] = 2.0 * varargin_1[10] * varargin_1[11] + 2.0 * varargin_1[12] *
    varargin_1[13];
  tmp_i[2] = 2.0 * varargin_1[10] * varargin_1[12] + 2.0 * varargin_1[11] *
    varargin_1[13];
  tmp_i[5] = -2.0 * varargin_1[10] * varargin_1[11] + 2.0 * varargin_1[12] *
    varargin_1[13];
  tmp_i[8] = (1.0 - varargin_1[11] * varargin_1[11] * 2.0) - varargin_1[12] *
    varargin_1[12] * 2.0;
  for (kkC = 0; kkC < 14; kkC++) {
    ...
    for (i = 0; i < 3; i++) {
      ...
      for (i_p = 0; i_p < 3; i_p++) {
        ...
        earthBF[i] += tmp_e[3 * i_p + i] * varargin_1[i_p + 7];
      }
  ...
  tmp[0] = (1.0 - varargin_1[12] * varargin_1[12] * 2.0) - varargin_1[13] *
    varargin_1[13] * 2.0;
  tmp[3] = 2.0 * varargin_1[11] * varargin_1[12] + 2.0 * varargin_1[10] *
    varargin_1[13];
  tmp[6] = -2.0 * varargin_1[10] * varargin_1[12] + 2.0 * varargin_1[11] *
    varargin_1[13];
  tmp[1] = 2.0 * varargin_1[11] * varargin_1[12] - 2.0 * varargin_1[10] *
    varargin_1[13];
  tmp[4] = (1.0 - varargin_1[11] * varargin_1[11] * 2.0) - varargin_1[13] *
    varargin_1[13] * 2.0;
  tmp[7] = 2.0 * varargin_1[10] * varargin_1[11] + 2.0 * varargin_1[12] *
    varargin_1[13];
  tmp[2] = 2.0 * varargin_1[10] * varargin_1[12] + 2.0 * varargin_1[11] *
    varargin_1[13];
  tmp[5] = -2.0 * varargin_1[10] * varargin_1[11] + 2.0 * varargin_1[12] *
    varargin_1[13];
  tmp[8] = (1.0 - varargin_1[11] * varargin_1[11] * 2.0) - varargin_1[12] *
    varargin_1[12] * 2.0;
  tmp_i[0] = (1.0 - X1[2] * X1[2] * 2.0) - X1[3] * X1[3] * 2.0;
  tmp_i[3] = 2.0 * X1[1] * X1[2] + 2.0 * X1[0] * X1[3];
  tmp_i[6] = -2.0 * X1[0] * X1[2] + 2.0 * X1[1] * X1[3];
  ...
  for (i = 0; i < 3; i++) {
    ...
    for (i_p = 0; i_p < 3; i_p++) {
      ...
      tmp_p[i + 3 * i_p] += tmp_i[3 * i_p + 1] * tmp[i + 3];
      tmp_p[i + 3 * i_p] += tmp_i[3 * i_p + 2] * tmp[i + 6];
      earthBF[i] += tmp_p[3 * i_p + i] * varargin_1[i_p + 7];
    }
  }
