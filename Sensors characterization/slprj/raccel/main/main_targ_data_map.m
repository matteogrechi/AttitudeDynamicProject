  ...
  ;%***********************
    ...
    ;%
      section.nData     = 388;
      section.data(388)  = dumData; %prealloc
	  ...
	  section.data(154).dtTransOffset = 277;
	  ...
	  section.data(209).dtTransOffset = 347;
	
	  ;% hbv5azo3sw.Sensororientation_Value
	  section.data(210).logicalSrcIdx = 212;
	  section.data(210).dtTransOffset = 348;
	  ...
	  section.data(213).dtTransOffset = 354;
	  ...
	  section.data(315).dtTransOffset = 481;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(70).dtTransOffset = 161;
	  ...
	  section.data(96).dtTransOffset = 187;
	
	  ;% o2y45zbt2m4.bzsae5g150
	  section.data(97).logicalSrcIdx = 97;
	  section.data(97).dtTransOffset = 188;
	  ...
	  section.data(115).dtTransOffset = 206;
	
	  ;% o2y45zbt2m4.pvvuqzjxh5
	  section.data(116).logicalSrcIdx = 116;
	  section.data(116).dtTransOffset = 207;
	  ...
	  section.data(159).dtTransOffset = 250;
	
	  ;% o2y45zbt2m4.daikka42e3
	  section.data(160).logicalSrcIdx = 160;
	  section.data(160).dtTransOffset = 251;
	  ...
	  section.data(188).dtTransOffset = 289;
	  ...
	  section.data(192).dtTransOffset = 299;
	
	  ;% o2y45zbt2m4.hi5t21up55
	  section.data(193).logicalSrcIdx = 193;
	  section.data(193).dtTransOffset = 300;
  ...
  targMap.checksum0 = 1034241853;
  targMap.checksum1 = 1459137020;
  targMap.checksum2 = 2277863048;
  targMap.checksum3 = 1221152103;
