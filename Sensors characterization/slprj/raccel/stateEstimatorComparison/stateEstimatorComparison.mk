...
MODEL                   = stateEstimatorComparison
MODULES                 = rt_logging.c stateEstimatorComparison.c stateEstimatorComparison_capi.c stateEstimatorComparison_data.c stateEstimatorComparison_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = stateEstimatorComparison
MAKEFILE                = stateEstimatorComparison.mk
MATLAB_ROOT             = /Applications/MATLAB_R2020b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2020b.app
START_DIR               = /Users/matteo/Documents/GitHub/AttitudeDynamicProject/Sensors\ characterization
...
CLASSIC_INTERFACE       = 1
TGT_FCN_LIB             = ISO_C
MODELREFS               = MagneticFieldInPolarCoords 
GEN_SAMPLE_MAIN         = 0
TARGET_LANG_EXT         = c
SHRLIBTARGET            = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = ../../../slprj/sim/MagneticFieldInPolarCoords/MagneticFieldInPolarCoordslib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../slprj/sim/MagneticFieldInPolarCoords/MagneticFieldInPolarCoordslib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../slprj/sim/MagneticFieldInPolarCoords/MagneticFieldInPolarCoordslib.a -Wl,--end-group
endif
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/MagneticFieldInPolarCoords \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/stateEstimatorComparison \
