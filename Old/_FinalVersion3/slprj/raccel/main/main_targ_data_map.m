  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% hbv5azo3sw.RandomSource1_MeanVal_arywbior3i
	  ...
	  section.data(97).dtTransOffset = 110;
	
	  ;% hbv5azo3sw.Gain2_Gain_nben4kjacq
	  section.data(98).logicalSrcIdx = 100;
	  section.data(98).dtTransOffset = 111;
	  ...
	  section.data(100).dtTransOffset = 113;
	
	  ;% hbv5azo3sw.Gain_Gain_fouuav1ki1
	  section.data(101).logicalSrcIdx = 103;
	  section.data(101).dtTransOffset = 114;
	  ...
	  section.data(104).dtTransOffset = 117;
	
	  ;% hbv5azo3sw.Gain1_Gain_n4q3gythod
	  section.data(105).logicalSrcIdx = 107;
	  section.data(105).dtTransOffset = 118;
	  ...
	  ;% hbv5azo3sw.Gain4_Gain_emojkepltb
	  ...
	  section.data(127).dtTransOffset = 143;
	
	  ;% hbv5azo3sw.Gain1_Gain_cftaqvkxoi
	  section.data(128).logicalSrcIdx = 130;
	  section.data(128).dtTransOffset = 144;
	  ...
	  section.data(197).dtTransOffset = 257;
	  ...
	  section.data(252).dtTransOffset = 320;
	  ...
	  section.data(372).dtTransOffset = 472;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% o2y45zbt2m4.mhup2avl2j
	  section.data(33).logicalSrcIdx = 32;
	  section.data(33).dtTransOffset = 78;
	
	  ;% o2y45zbt2m4.d1vosmg1qx
	  ...
	  section.data(63).dtTransOffset = 141;
	  ...
	  section.data(65).dtTransOffset = 143;
	  ...
	  section.data(72).dtTransOffset = 164;
	  ...
	  section.data(92).dtTransOffset = 195;
	  ...
	  section.data(94).dtTransOffset = 197;
	  ...
	  section.data(113).dtTransOffset = 216;
	
	  ;% o2y45zbt2m4.fxqr3to5iu
	  section.data(114).logicalSrcIdx = 114;
	  section.data(114).dtTransOffset = 217;
	  ...
	  section.data(130).dtTransOffset = 233;
	  ...
	  section.data(134).dtTransOffset = 237;
	  ...
	  section.data(187).dtTransOffset = 290;
	
	  ;% o2y45zbt2m4.kwmlekgm0w
	  section.data(188).logicalSrcIdx = 188;
	  section.data(188).dtTransOffset = 291;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% hrxu5rhe3af.lwlvgtt2ve
	  section.data(1).logicalSrcIdx = 1;
	  section.data(1).dtTransOffset = 0;
	
	  ;% hrxu5rhe3af.fcn1wq25nc
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 1;
	
	  ;% hrxu5rhe3af.ajsna343fp
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 5;
	
	  ;% hrxu5rhe3af.eoflwqidz3
	  ...
	  ;% hrxu5rhe3af.egoydukc0c.LoggedData
	  ...
	  ;% hrxu5rhe3af.osdalvocf4.LoggedData
  ...
  targMap.checksum0 = 3050408842;
  targMap.checksum1 = 2580869559;
  targMap.checksum2 = 1326524716;
  targMap.checksum3 = 1093264084;
