...
rtDimensionArray } , "float" , { 762576812U , 680982503U , 3058591188U ,
2703168275U } , & mmiStaticInfoLogging , 0 , 0 , rt_LoggedStateIdxList } ;
const rtwCAPI_ModelMappingStaticInfo *
MagneticFieldInPolarCoords_GetCAPIStaticMap ( void ) { return & mmiStatic ; }
