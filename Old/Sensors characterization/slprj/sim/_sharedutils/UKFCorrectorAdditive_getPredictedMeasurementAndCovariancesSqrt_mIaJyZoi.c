...
#include "UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_mIaJyZoi.h"

void UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_mIaJyZoi(
  ...
  Pxy[49], real_T Sy[49])
{
  ...
  static const real_T c_a[9] = { 2.2204460492503131E-16, -0.0, -1.0, 0.0, 1.0,
    -0.0, 1.0, 0.0, 2.2204460492503131E-16 };
