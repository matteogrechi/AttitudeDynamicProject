...
#include "UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_xWFpVZLt.h"

void UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_xWFpVZLt(
  ...
  Pxy[49], real_T Sy[49])
{
  ...
  static const real_T c_a[9] = { -1.0, -1.2246467991473532E-16, 0.0,
