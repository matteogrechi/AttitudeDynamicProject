...
#include "UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_6a5PKxRk.h"

void UKFCorrectorAdditive_getPredictedMeasurementAndCovariancesSqrt_6a5PKxRk(
  ...
  Pxy[49], real_T Sy[49])
{
  ...
  static const real_T c_a[9] = { -1.0, 0.0, 1.2246467991473532E-16, 0.0, 1.0,
    0.0, -1.2246467991473532E-16, 0.0, -1.0 };
