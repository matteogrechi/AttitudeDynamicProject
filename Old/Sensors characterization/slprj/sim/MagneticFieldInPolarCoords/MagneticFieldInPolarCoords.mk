...
MODEL                   = MagneticFieldInPolarCoords
MODULES                 = MagneticFieldInPolarCoords.c MagneticFieldInPolarCoords_capi.c
PRODUCT                 = MagneticFieldInPolarCoordslib.a
MAKEFILE                = MagneticFieldInPolarCoords.mk
MATLAB_ROOT             = /Applications/MATLAB_R2020b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2020b.app
START_DIR               = /Users/matteo/Desktop/Spacecraft\ attitude\ dynamics\ and\ controls/FinalProject/Simulinkv2
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = MACI64
BUILDARGS               =  GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.14"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2020b.app/bin/maci64" -lfixedpoint -lmwmathutil -lmwipp -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lcovrt
...
MODELLIB                  = MagneticFieldInPolarCoordslib.a
MODELREF_LINK_LIBS        = 
