...
( SimStruct * S , int_T tid ) { mcbsajulppp * dw = ( mcbsajulppp * )
ssGetDWork ( S , 0 ) ; const real_T * i_f0n022r1vv = ( real_T * )
ssGetInputPortSignal ( S , 0 ) ; const real_T * i_nm40sh1y45 = ( real_T * )
ssGetInputPortSignal ( S , 1 ) ; const real_T * i_jtdehxioah = ( real_T * )
ssGetInputPortSignal ( S , 2 ) ; const real_T * i_ox4mbuo52o = ( real_T * )
ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_2_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) {
...
; const real_T * i_f0n022r1vv = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_nm40sh1y45 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_jtdehxioah = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
const real_T * i_ox4mbuo52o = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
...
mr_MagneticFieldInPolarCoords_GetDWork ( ssGetDWork ( S , 0 ) ) ;
