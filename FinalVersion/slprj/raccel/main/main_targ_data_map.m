  ...
  ;%***********************
    ...
    ;%
      section.nData     = 401;
      section.data(401)  = dumData; %prealloc
	  ...
	  section.data(167).dtTransOffset = 290;
	  ...
	  section.data(222).dtTransOffset = 360;
	
	  ;% hbv5azo3sw.Sensororientation_Value
	  section.data(223).logicalSrcIdx = 225;
	  section.data(223).dtTransOffset = 361;
	  ...
	  section.data(267).dtTransOffset = 417;
	  ...
	  section.data(7).logicalSrcIdx = 410;
	  section.data(7).dtTransOffset = 6;
  ...
  targMap.checksum0 = 47910091;
  targMap.checksum1 = 3490231339;
  targMap.checksum2 = 3896331790;
  targMap.checksum3 = 2484613374;
